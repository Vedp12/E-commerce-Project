...
!(function (e, t, n) {
  ...
  function g(e, t, o, i) {
    ...
    for (
      var f, c, p, h, g, v = ["modernizr", "tspan", "samp"];
      !R.style && v.length;
  ...
  Modernizr.addTest("svgclippaths", function () {
    return (
      !!t.createElementNS &&
      /SVGClipPath/.test(
        P.call(t.createElementNS("http://www.w3.org/2000/svg", "clipPath"))
      )
    );
  });
  var z;
